...
module Paid
  class CustomersClient
    ...
    def create(name:, external_id: nil, phone: nil, employee_count: nil, annual_revenue: nil, tax_exempt_status: nil,
               creation_source: nil, website: nil, billing_address: nil, request_options: nil)
